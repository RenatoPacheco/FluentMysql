...
{
    public class AutenticarUsuarioTemp
    {
        ...
        {
            string resultado = File.ReadAllText(HttpContext.Current.Server.MapPath("~/Areas/Admin/Template/Email/AutenticarUsuario.html"));
        ...
        public AutenticarUsuarioTemp(string nome, string link, string empresa)
        {
            Nome = nome;
            Link = link;
            Empresa = empresa;
