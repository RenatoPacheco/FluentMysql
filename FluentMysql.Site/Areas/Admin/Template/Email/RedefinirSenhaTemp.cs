...
{
    public class RedefinirSenhaTemp
    {
        ...
        {
            string resultado = File.ReadAllText(HttpContext.Current.Server.MapPath("~/Areas/Admin/Template/Email/RedefinirSenha.html"));
        ...
        public RedefinirSenhaTemp(string nome, string link, string empresa)
        {
            Nome = nome;
            Link = link;
            Empresa = empresa;
