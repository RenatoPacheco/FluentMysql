...
namespace FluentMysql.Site.DataAnnotations
{
    ...
    public class FormatarViewJsonAttribute : Attribute, IFormatarViewAttribute
    {
        ...
        public FormatarViewJsonAttribute(string palavraChave)
            : this(palavraChave, null, null) { }

        public FormatarViewJsonAttribute(string palavraChave, string[] viewData)
            : this(palavraChave, viewData, null) { }

        public FormatarViewJsonAttribute(string palavraChave, string[] viewData, string[] tempData)
        {
        ...
        string IFormatarViewAttribute.Tipo { get { return "json"; } }
